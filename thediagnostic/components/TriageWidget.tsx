      ...
      <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start', marginBottom: 20 }}>
        ...
        <div>
          ...
          <p style={{ fontSize: 13, color: 'var(--text-muted)', lineHeight: 1.5 }}>
            Describe your symptoms or the scan your doctor recommended — our AI will suggest the most appropriate diagnostic scan.
          </p>
        </div>
      </div>
      ...
      {!result ? (
        <form onSubmit={handleSubmit}>
          <textarea
            ...
            placeholder="e.g. 'I've had unexplained weight loss and fatigue for 3 months. My GP wants a scan to check for lymphoma.' or 'My doctor recommended a PET-CT for cancer staging.'"
            rows={4}
            style={{
          ...
          <div style={{ display: 'flex', gap: 10, marginTop: 12, alignItems: 'center' }}>
            ...
            <span style={{ fontSize: 12, color: 'var(--text-muted)' }}>Powered by Claude AI · Not a medical diagnosis</span>
          </div>
        </form>
      ) : (
        <div>
